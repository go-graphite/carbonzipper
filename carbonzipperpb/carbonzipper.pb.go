...
type ResolveResponse struct {
	...
	Suffix           *string  `protobuf:"bytes,2,req,name=suffix" json:"suffix,omitempty"`
	Replacements     []string `protobuf:"bytes,3,rep,name=replacements" json:"replacements,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *ResolveResponse) GetPrefix() string {
...
func (m *ResolveResponse) GetSuffix() string {
...
func (m *ResolveResponse) GetReplacements() []string {
	if m != nil {
