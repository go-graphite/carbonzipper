...
type MultiGlobResponse struct {
	Metrics map[string]GlobMatch `protobuf:"bytes,1,rep,name=metrics" json:"metrics" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *MultiGlobResponse) GetMetrics() map[string]GlobMatch {
	if m != nil {
		return m.Metrics
	}
	return nil
...
func (m *MultiGlobResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Metrics == nil {
				m.Metrics = make(map[string]GlobMatch)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorCarbonzippergrpcpb = []byte{
	...
	,
}
